<?php
/**
 * Portable PHP password hashing framework — compatible WordPress
 * Source : https://www.openwall.com/phpass/
 * Utilisé uniquement pour vérifier les mots de passe migrés depuis WordPress.
 * Une fois le client connecté, son hash est migré vers bcrypt.
 */
class PasswordHash {
    var $itoa64;
    ...
    function HashPassword($password) {
        ...
        return crypt($password, $this->gensalt_blowfish($random));
    }
